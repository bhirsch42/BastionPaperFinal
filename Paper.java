...
public class Paper {
	...
	public static final String[][] showing = {
		...
		"final namelessness backstory. exposition discovering lore history optional conversations backstory".split(" "),
		"compelling exploration foreshadowing revelations journal native tongue Too much.\" shards".split(" "),
